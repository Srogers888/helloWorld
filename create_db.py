...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'srogers7', 'email': 'srogers7@umd.edu', 'first_name': 'Saraiya', 'last_name': 'Rogers',
         'password': generate_password_hash('srogers7', method='pbkdf2:sha256'), 'role': 'STUDENT'},
